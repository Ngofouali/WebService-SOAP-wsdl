 ...
 * generated in the STUB_Proxy package. 
...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToMAD_QNAME = new QName("http://banqueservice.icodi.com/", "ConversionEuroToMAD");
    private static final QName _ConversionEuroToMADResponse_QNAME = new QName("http://banqueservice.icodi.com/", "ConversionEuroToMADResponse");
    private static final QName _GetCompte_QNAME = new QName("http://banqueservice.icodi.com/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://banqueservice.icodi.com/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://banqueservice.icodi.com/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://banqueservice.icodi.com/", "listComptesResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: STUB_Proxy
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://banqueservice.icodi.com/", name = "ConversionEuroToMAD")
     ...
     */
    @XmlElementDecl(namespace = "http://banqueservice.icodi.com/", name = "ConversionEuroToMADResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://banqueservice.icodi.com/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://banqueservice.icodi.com/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://banqueservice.icodi.com/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://banqueservice.icodi.com/", name = "listComptesResponse")
