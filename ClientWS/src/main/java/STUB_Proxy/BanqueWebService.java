 ...
 * 
 */
@WebServiceClient(name = "BanqueWebService", targetNamespace = "http://banqueservice.icodi.com/", wsdlLocation = "http://localhost:8585/banqueservice?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWEBSERVICE_QNAME = new QName("http://banqueservice.icodi.com/", "BanqueWebService");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://banqueservice.icodi.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://banqueservice.icodi.com/", "BanqueServicePort"), BanqueService.class, features);
    }
